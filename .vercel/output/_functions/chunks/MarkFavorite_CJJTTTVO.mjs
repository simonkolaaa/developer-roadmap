...
import { S as Spinner, c as cn, b as httpPatch } from './BaseLayout_DetAB5fP.mjs';
...
function MarkFavorite({
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: isLoading ? /* @__PURE__ */ jsx(Spinner, { isDualRing: false }) : /* @__PURE__ */ jsx(FavoriteIcon, { isFavorite })
    }
  );
}

export { MarkFavorite as M };
