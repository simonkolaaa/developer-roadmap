...
- [@article@https://en.wikipedia.org/wiki/Bash\_(Unix_shell)#:~:text=Bash (short for "Bourne Again,Chet Ramey)](<https://en.wikipedia.org/wiki/Bash_(Unix_shell)#:~:text=Bash%20(short%20for%20%22Bourne%20Again,Chet%20Ramey)>)
