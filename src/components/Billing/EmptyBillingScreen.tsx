...
export function EmptyBillingScreen(props: EmptyBillingScreenProps) {
  ...
  return (
    <div className="mt-12 flex h-full w-full flex-col items-center">
      ...
      <button
        onClick={onUpgrade}
        className="inline-flex items-center justify-center rounded-lg bg-black px-6 py-2.5 text-sm font-medium text-white transition-colors hover:opacity-80 focus:ring-2 focus:ring-black focus:ring-offset-2 focus:outline-hidden"
      >
        Upgrade Account
      </button>
    </div>
