...
export function PickRoadmapOptionModal(props: PickRoadmapOptionModalProps) {
  ...
  return (
    <Modal onClose={onClose} bodyClassName="p-4">
      <h2 className="mb-0.5 text-left text-2xl font-semibold">
        Pick an Option
      </h2>
      ...
      <div className="flex flex-col gap-2">
        <button
          className="flex items-center rounded-md border border-gray-300 p-2 px-4 text-left text-base font-medium hover:bg-gray-100"
