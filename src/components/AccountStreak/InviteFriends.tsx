...
export function InviteFriends(props: InviteFriendsProps) {
  ...
  return (
    <div className="-mx-4 mt-6 flex flex-col border-t border-dashed border-t-slate-600 px-4 pt-5 text-center text-sm">
      ...
      <div className="my-4 flex flex-col items-center rounded-lg bg-slate-900/40 pt-5 pb-4">
        ...
        <p className="text-slate-500">
          <button
            ...
            className={cn(
              'rounded-md bg-slate-600 px-3 py-1 text-xs text-slate-300 hover:bg-slate-500/80 hover:text-slate-100',
              {
