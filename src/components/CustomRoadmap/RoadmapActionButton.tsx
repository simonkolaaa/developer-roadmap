  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white py-1.5 pr-2 pl-2 text-xs font-medium text-black hover:border-gray-300 hover:bg-gray-300 sm:pr-3 sm:pl-1.5 sm:text-sm"
      >
      ...
      {isOpen && (
        <div
          ref={menuRef}
          className="align-right absolute top-full right-0 z-9999 mt-1 w-[140px] rounded-md bg-slate-800 px-2 py-2 text-white shadow-md"
        >
          <ul>
            {onCustomize && (
              <li>
